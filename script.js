document.addEventListener('DOMContentLoaded', () => {
    ...
    function showChat(name) {
        ...
        // Show the correct view based on name
        if (name === ADMIN_NAME) {
    ...
    function sendMessage() {
        ...
        let to;
        // Admin logic for sending messages
        if (from === ADMIN_NAME) {
            // Admin replies using format: @username message
            if (text.startsWith('@')) {
